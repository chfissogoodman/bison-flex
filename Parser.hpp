...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // library
      char dummy2[sizeof (lib::library*)];

      // operating_condition
      char dummy3[sizeof (lib::operating_conditions*)];

      // stuff
      char dummy4[sizeof (std::pair<std::string, std::string>)];
      ...
      // stuffs
      char dummy6[sizeof (std::unordered_map<std::string, std::string>*)];

      // operating_conditions
      char dummy7[sizeof (std::vector<lib::operating_conditions*>*)];
    };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_RPAREN = 8,                            // RPAREN
        S_COL = 9,                               // COL
        S_SEMICOL = 10,                          // SEMICOL
        S_COMMA = 11,                            // COMMA
        S_NUMBER = 12,                           // NUMBER
        S_STRING = 13,                           // STRING
        S_IDENTIFIER = 14,                       // IDENTIFIER
        S_YYACCEPT = 15,                         // $accept
        S_library = 16,                          // library
        S_stuffs = 17,                           // stuffs
        S_operating_conditions = 18,             // operating_conditions
        S_stuff = 19,                            // stuff
        S_operating_condition = 20               // operating_condition
      };
    };
        ...
        switch (this->kind ())
    {
      ...
      case symbol_kind::S_library: // library
        value.move< lib::library* > (std::move (that.value));
        break;

      case symbol_kind::S_operating_condition: // operating_condition
        value.move< lib::operating_conditions* > (std::move (that.value));
        break;
      ...
      case symbol_kind::S_operating_conditions: // operating_conditions
        value.move< std::vector<lib::operating_conditions*>* > (std::move (that.value));
        break;
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, lib::library*&& v)
        : Base (t)
        , value (std::move (v))
      {}
#else
      basic_symbol (typename Base::kind_type t, const lib::library*& v)
        : Base (t)
        , value (v)
      {}
#endif
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, lib::operating_conditions*&& v)
        : Base (t)
        , value (std::move (v))
      {}
#else
      basic_symbol (typename Base::kind_type t, const lib::operating_conditions*& v)
        : Base (t)
        , value (v)
      {}
#endif
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::vector<lib::operating_conditions*>*&& v)
        : Base (t)
        , value (std::move (v))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::vector<lib::operating_conditions*>*& v)
        : Base (t)
        , value (v)
      {}
#endif
...
switch (yykind)
    {
      ...
      case symbol_kind::S_library: // library
        value.template destroy< lib::library* > ();
        break;

      case symbol_kind::S_operating_condition: // operating_condition
        value.template destroy< lib::operating_conditions* > ();
        break;
      ...
      case symbol_kind::S_operating_conditions: // operating_conditions
        value.template destroy< std::vector<lib::operating_conditions*>* > ();
        break;
    ...
    // Implementation of make_symbol for each token kind.
      ...
      make_SEMICOL ()
      {
        return symbol_type (token::SEMICOL);
      }
#else
      static
      symbol_type
